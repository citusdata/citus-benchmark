...
bin/ycsb load jdbc \
    ...
    -p db.url="jdbc:postgresql://$CITUS_HOST/citus?loadBalanceHosts=true" | tee ${HOMEDIR}/load_${WORKLOAD}_${MONITOR_THREADS}_${RECORDS}_${ITERATION}_${WORKERS}_${RESOURCE}_${DRIVERS}_${PART}.mlog
