...
TK_LIBS='-lX11 -lXft -lfontconfig  -lpthread -ldl -lz  -lpthread -lm'

# Top-level directory in which Tk's platform-independent files are
# installed.
TK_PREFIX='/home/steve/V3TCLSOURCE/LINUXX64/hdbpacklinux_v5/local'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/home/steve/V3TCLSOURCE/LINUXX64/hdbpacklinux_v5/local'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/home/steve/V3TCLSOURCE/LINUXX64/hdbpacklinux_v5/tk8.6.9/unix -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/home/steve/V3TCLSOURCE/LINUXX64/hdbpacklinux_v5/local/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/home/steve/V3TCLSOURCE/LINUXX64/hdbpacklinux_v5/local/include'
...
# compiled.
TK_SRC_DIR='/home/steve/V3TCLSOURCE/LINUXX64/hdbpacklinux_v5/tk8.6.9'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/home/steve/V3TCLSOURCE/LINUXX64/hdbpacklinux_v5/tk8.6.9/unix -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/home/steve/V3TCLSOURCE/LINUXX64/hdbpacklinux_v5/local/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/home/steve/V3TCLSOURCE/LINUXX64/hdbpacklinux_v5/tk8.6.9/unix/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/home/steve/V3TCLSOURCE/LINUXX64/hdbpacklinux_v5/local/lib/libtkstub8.6.a'
