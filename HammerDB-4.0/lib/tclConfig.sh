...
# installed.
TCL_PREFIX='/home/steve/V3TCLSOURCE/LINUXX64/hdbpacklinux_v5/local'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/steve/V3TCLSOURCE/LINUXX64/hdbpacklinux_v5/local'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/steve/V3TCLSOURCE/LINUXX64/hdbpacklinux_v5/tcl8.6.9/unix -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/steve/V3TCLSOURCE/LINUXX64/hdbpacklinux_v5/local/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/steve/V3TCLSOURCE/LINUXX64/hdbpacklinux_v5/local/include'
...
# compiled.
TCL_SRC_DIR='/home/steve/V3TCLSOURCE/LINUXX64/hdbpacklinux_v5/tcl8.6.9'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/home/steve/V3TCLSOURCE/LINUXX64/hdbpacklinux_v5/local/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/steve/V3TCLSOURCE/LINUXX64/hdbpacklinux_v5/tcl8.6.9/unix -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/steve/V3TCLSOURCE/LINUXX64/hdbpacklinux_v5/local/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/steve/V3TCLSOURCE/LINUXX64/hdbpacklinux_v5/tcl8.6.9/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/home/steve/V3TCLSOURCE/LINUXX64/hdbpacklinux_v5/local/lib/libtclstub8.6.a'
